...
pcmovehard([b,b,b,b,b,b,b,b,b], NewBoard):-
  cornermove([b,b,b,b,b,b,b,b,b], o, Newboard).
...
displayboard([A,B,C,D,E,F,G,H,I]):- write([A,B,C]),nl,write([D,E,F]),nl,write([G,H,I]),nl.
